...
2. If using Ubuntu-linux then you need to install libcurl openssl to be able to install the googledrive package in later steps (mainly due to curl and httr dependency packages). You don't need to do this if you're on MacOS.
